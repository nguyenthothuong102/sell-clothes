...
<main class="app-layout-content" style="padding-top: 30px;">
  <div  class="container-fluid p-y-md">
    <ul style="list-style: none;padding-bottom: 40px" class="navbar-nav mr-auto">
                        <li><a href="{{route('manager.products.index')}}"> Quần áo</a></li>
                        <li>&nbsp;&nbsp;&nbsp; || &nbsp;&nbsp;&nbsp;</li>
                        <li><a href="{{ route('manager.product.create')}}"> Tạo Quần áo mới </a></li>
    </ul>
  </div>
    ...
    <div class="container">
      <div class="card">
        <div class="card-header"><h2>Thêm Size cho sản phẩm</h2></div>
          <div class="card-body">
            <form action="{{ route('manager.products.storeProductSize', $product->id)}}" method="post">
             @csrf
              <div class="container mt-3">
                <fieldset class="form-group">
                    ...
                    <p class="meserr" style="color:red">{{ $errors->first('size') }}</p>
                  </fieldset>
                <fieldset class="form-group">
