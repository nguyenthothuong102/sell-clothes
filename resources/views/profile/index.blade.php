                            ...
                            <div class="card rounded col-md-10 m-3 p-4">
                                ...
                                <form action="{!! route('update_profile_manager',$user->id) !!}" method="post">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputname3" class="col-sm-3 col-form-label">Tên</label>
                                        <div class="col-sm-9">
                                            <input type="text"
                                                   class="form-control {{ $errors->has('last_name') ? ' is-invalid' : '' }}"
                                                   id="inputname3" name="last_name" value="{{$user->last_name}}">
                                            @if ($errors->has('name'))
                                     ...
                                     <div class="form-group row">
                                        <label for="inputname3" class="col-sm-3 col-form-label">Họ</label>
                                        <div class="col-sm-9">
                                            <input type="text"
                                                   class="form-control {{ $errors->has('first_name') ? ' is-invalid' : '' }}"
                                                   id="inputname3" name="first_name" value="{{$user->first_name}}">
                                            @if ($errors->has('name'))
                                                <span class="invalid-feedback" role="alert">
                                                <strong>{{ $errors->first('name') }}</strong>
                                            </span>
